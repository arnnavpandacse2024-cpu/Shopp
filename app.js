...
// Use Socket.io WebSockets for instant real-time sync
function startRealTimeSync() {
  if (typeof io !== 'undefined') {
    ...
    console.log('⚡ WebSocket real-time instant sync started');
  } else {
    console.warn('⚠️ Socket.io not loaded. Falling back to 5s polling.');
    setInterval(async () => {
      if (_isSyncing) return;
      _isSyncing = true;
      _showSyncIndicator('syncing');
